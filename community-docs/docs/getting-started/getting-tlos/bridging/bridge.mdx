...
pNetwork supports movement of TLOS from Telos Zero to Ethereum and BNBChain.
It also supports, movement of tokens like ETH, BTC, USDC, USDT and a few other from Ethereum chain to Telos.
